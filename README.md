...
#    骨架仓库 = kode/skeleton；本仓库（kode/framework）自 v1.1.2 起为纯内核，作为依赖被引入
...
# {"status":"ok","service":"kode-app","version":"1.1.2","php":"8.3.33","env":"local","time":0.52}
...
--- KODE ---------------------------------------------------------------------
Kode Framework version:1.1.2          PHP version:8.3.33
...
> 框架在 v1.1.2 补了「快速排空」看门狗：收到信号后一旦在途请求归零就立即结束事件循环，
...
- 当前版本：**[v1.1.2](https://github.com/kodephp/framework/releases)**
