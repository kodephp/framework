 ...
 *
 * 默认**离路径异步导出**（v1.0.0，与 v1.0.0 访问日志同范式）：record() 在热路径上只
...
final class AuditService
{
     ...
     *
     * v1.0.0 起移至 {@see QueryMasker::DEFAULT_MASK_PARAMS}，本常量保留为兼容别名
    ...
    /**
     * 脱敏查询串（v1.0.0 起委托 {@see QueryMasker}，与访问日志共用实现）。
     */
     ...
     *
     * 修复说明（v1.0.0）：旧实现「读取后立即清除」，导致同一请求内先执行一次审计后，
